<template>
  <div class="node-panel">
    ...
    <div class="node-item" @mousedown="addCircleNode()">
      <div class="node-item-icon circle"></div>
      <span class="node-label">圆形</span>
    </div>
...
import CustomerCircle from "../registerNode/CustomerCircle";
